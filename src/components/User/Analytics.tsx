    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      {reports.length === 0 ? (
        ...
        reports.map((r) => {
          ...
          const whatsappUrl = `https://wa.me/?text=Animal%20Report%20(${r.status})%0AType:%20${r.animal}%0ALocation:%20${r.location}%0ADescription:%20${r.description || "N/A"}%0AView%20on%20Map:%20${mapUrl}`;

          return (
            <Card
              key={r.id}
              title={`${r.animal.toUpperCase()} - ${r.status.toUpperCase()}`}
